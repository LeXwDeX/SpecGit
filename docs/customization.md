> **Archived v1 reference.** These commands and integration rules describe the retired TypeScript CLI. For current work use the [v2 agent guide](supported-tools.md), [installation guide](installation.md), and [native command reference](../runtime/REFERENCE.md). The historical support page is preserved at [supported-tools-v1](legacy/supported-tools-v1.md). npm distribution is retired.
